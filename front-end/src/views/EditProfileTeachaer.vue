  ...
  <div class="mx-auto">
    ...
    <div class="flex items-center flex-col w-full max-w-lg mx-auto border-gray-200 rounded-lg">
      ...
      <div class="flex flex-col w-96 m-1">
        ...
        <textarea id="detail" v-model="teacher.desc" class="w-96 p-2 border border-gray-300 rounded"></textarea>
      </div>
      ...
      <div class="flex flex-col w-96 py-3">
        <button @click="updateTeacher" class="w-full bg-sky-600 text-white font-bold py-2 rounded-md hover:bg-sky-800">
          Save
        </button>
      </div>
    </div>
